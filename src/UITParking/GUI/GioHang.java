            ...
            try {
                ...
                if (slVe2000Dong > 0) {
                    ...
                    for (int i = 0; i < slVe2000Dong; i++) {
                        ...
                        VeDTO ve = new VeDTO(maVe, "LVE02", kh.getStrMaKH(),  "Chưa kích hoạt", null, null);
                        vetbl.them(ve);
                    }
                }
                if (slVe3000Dong > 0) {
                    ...
                    for (int i = 0; i < slVe3000Dong; i++) {
                        String maVe = vetbl.getMaxMaVe();
                        VeDTO ve = new VeDTO(maVe, "LVE01", kh.getStrMaKH(), "Chưa kích hoạt", null, null);
                        vetbl.them(ve);
                    }
                }
                if (slVe25000Dong > 0) {
                    ...
                    for (int i = 0; i < slVe25000Dong; i++) {
                        String maVe = vetbl.getMaxMaVe();
                        VeDTO ve = new VeDTO(maVe, "LVE03", kh.getStrMaKH(), "Chưa kích hoạt", null, null);
                        vetbl.them(ve);
                    }
                }
                if (slVe95000Dong > 0) {
                    ...
                    for (int i = 0; i < slVe95000Dong; i++) {
                        String maVe = vetbl.getMaxMaVe();
                        VeDTO ve = new VeDTO(maVe, "LVE04", kh.getStrMaKH(), "Chưa kích hoạt", null, null);
                        vetbl.them(ve);
                    }
                }
